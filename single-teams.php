...
<div class="main-content"> 
  <!-- Breadcrumbs Start -->
  <?php  get_template_part( 'inc/page-header/breadcrumbs-team' ); ?>
  <!-- Breadcrumbs End --> 
    ...
    ?>
      <div class="row">
        <div class="col-md-4 col-sm-12">
          <div class="ps-image">
            ...
            <ul>
              <?php if($designation):?>
                <li><span>
                  <?php esc_html_e( 'Designation:','mifo' );?>
              ...
              <?php if($company):?>
                <li>
                  <span><?php esc_html_e( 'Company:','mifo' );?></span>
        ...
        <div class="col-md-8 col-sm-12">
          ...
          <div class="ps-informations">
            <h3 class="info-title">
              <?php esc_html_e( 'Team Information','mifo' );?>
            </h3>
            <ul>
              <?php if($address):?>
              <li>
                <span>
                <?php esc_html_e( 'Address:','mifo' );?>
                </span>
      ...
      <div class="project-desc">        
        <?php
            ...
            wp_link_pages( array(
              'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'mifo' ),
              'after'  => '</div>',
            ) );
          ?>
      </div>
