   ...
   Redux::setSection( $opt_name, array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        array(
                                ...
                                'subtitle' => __('Select and re-order component that you want to display at top header.', 'redux-framework-demo'),
		 ...
		 array(
                                'id'       => 'middlemenu-sortable',
                                'type'     => 'sortable',
                                'title'    => __('Middle Header', 'redux-framework-demo'),
                                'subtitle' => __('Select and re-order component that you want to display at middle header'),
                                // 'desc'     => __('This is the description field, again good for additional info.', 'redux-framework-demo'),
                                'mode'     => 'checkbox',
                                'options'  => array(
                                    'logo'     => 'Logo',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(        
							...
							array(
                                'id'       => 'blog-sortable',
                                'type'     => 'sortable',
                                'title'    => __('Blog/Archive', 'redux-framework-demo'),
                                'subtitle' => __('Select and re-order component that you want to display at blog/archive'),
                                // 'desc'     => __('This is the description field, again good for additional info.', 'redux-framework-demo'),
                                'mode'     => 'checkbox',
                                'options'  => array(
                                    'title'     => 'Title',
                ...
                'options' => array(
                    "enabled" => array(
                        ...
                        "popular" => "Popular Wallpaper",
                        "random" => "Random Wallpaper",
                        "recent" => "Recent Wallpaper",
                        //"services" => "Services"
                    ),
                    "disabled" => array(
                        "placebo" => "placebo", //REQUIRED!
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(                           
                           ...
                           array(
                                'id'       => 'singletop-sortable',
                                'type'     => 'sortable',
                                'title'    => __('Top Section', 'redux-framework-demo'),
                                'subtitle' => __('Select and re-order component that you want to display at single post'),
                                // 'desc'     => __('This is the description field, again good for additional info.', 'redux-framework-demo'),
                                'mode'     => 'checkbox',
                                'options'  => array(
                                    'title'     => 'Title',
